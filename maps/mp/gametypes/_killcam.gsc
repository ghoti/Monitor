...
init()
{
    // We've hijacked the killcam thread to start monitor, which is really just creating some dvars :D
    // once we are done setting ourselves up, things carry on as usual
     thread maps\mp\monitor\_main::init();
